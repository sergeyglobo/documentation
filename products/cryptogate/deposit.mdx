...
<Steps>
  <Step title="Проект запрашивает список доступных сетей и ассетов">
    Проект запрашивает список доступных сетей и ассетов используя метод [/api/v3/gate/get-address/currencies/](https://vima.mintlify.app/api-reference/api-reference/получить-список-доступных-криптовалют-для-получения-адреса?playground=open) или [/api/v3/gate/get-url/currencies/](https://vima.mintlify.app/api-reference/api-reference/получить-список-доступных-криптовалют-для-генерации-url?playground=open).
