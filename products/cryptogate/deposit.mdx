...
<Steps>
  <Step title="Проект запрашивает список доступных сетей и ассетов">
    Проект запрашивает список доступных сетей, криптоактивов и минимальных сумм депозита с помощью метода `GET /gate/deposit/currencies/{payment_profile}`.

    <Expandable title="Пример запроса">
    ...
    <Expandable title="Пример ответа">
  ...
  <Step title="Сервис осуществляет отправку уведомления в проект">
    ...
    <Expandable title="Примеры колбеков">
...
<Warning>
  Минимальные суммы операций следует уточнить в чате интеграции
</Warning>
