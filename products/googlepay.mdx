...
--data-raw '{
  ...
  <Step title="Получение платёжной страницы">
    ...
    "success": true,
    "result": {
        "url": "https://crypto.cheipho.com/payment-front/e16680e7-80fc-4b3a-82bf-a1e2dd588164",
        "reference_id": "2390adbd-2c5b-4022-b62f-5245478a2584"
    },
    "trace_id": "b5aabff3250146cb9ca1cefce637f88f"
}
      ```
    </Accordion>
  </Step>
  ...
  <Step title="Уведомление о завершении операции">
    ...
    <Accordion title="Пример уведомления" icon="server">
      ```json
           {
            "reference_id": "2390adbd-2c5b-4022-b62f-5245478a2584",
            "client_operation_id": "xOahj5tmK84TDF4QW0",
            "result": "complete",
            "deposit": {
                "amount": 20.1,
                "currency": "EUR"
            ...
            "payment_method_code": "000_test_googlepay"
        }
      ```
...
<ParamField path="payment_method_code" type="string">
  Код пплатёжного метода. `000_test_googlepay`
</ParamField>
